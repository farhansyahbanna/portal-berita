...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Farhan\Kuliah\Semester 5\Berkas Magang\Dafidea\ts-backend-dafidea\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Farhan\\Kuliah\\Semester 5\\Berkas Magang\\Dafidea\\ts-backend-dafidea\\public\\storage','logging.default',
...
'web','api',);
        registerArgumentsSet('routes', 'home','posts.index','posts.show','comments.store','password.simple.request','password.simple.reset','login',
'logout','password.request','password.email','password.reset','password.update',
'admin.dashboard','admin.posts.index','admin.posts.create','admin.posts.store','admin.posts.show',
'admin.posts.edit','admin.posts.update','admin.posts.destroy','admin.comments.index','admin.comments.destroy',
'admin.posts.update','storage.local',);
        registerArgumentsSet('views', 
'admin.comments.index','admin.dashboard','admin.layout','admin.posts.create','admin.posts.edit',
'admin.posts.index','auth.login','auth.passwords.email','auth.passwords.forgot-password','layout',
'posts.index','posts.show','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
